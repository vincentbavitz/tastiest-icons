...
function SvgSearchPrimaryIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      id="search-primary-icon_svg__Layer_1"
      data-name="Layer 1"
    ...
    >
      <defs>
        <style>{'.search-primary-icon_svg__cls-1{fill:#fe4c00}'}</style>
      </defs>
      <path
        className="search-primary-icon_svg__cls-1"
...
export default SvgSearchPrimaryIcon;
